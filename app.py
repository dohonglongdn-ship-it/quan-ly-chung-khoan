...
st.title("📈 Hệ thống Phân tích Chứng khoán Pro (Real-time VNDirect)")
...
# --- VŨ KHÍ TỐI THƯỢNG: KẾT NỐI VNDIRECT VỚI THỜI GIAN THỰC TẾ ---
@st.cache_data(ttl=900, show_spinner=False)
def lay_du_lieu(ma):
    loi_chi_tiet = []
    
    # MỞ KHÓA THỜI GIAN: Tự động lấy mốc thời gian của ngày hôm nay lùi về đúng 1 năm
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            if data.get('s') == 'ok' and data.get('t'):
                ...
                # GIẢI MÃ: Nhân 1000 để trả lại mệnh giá VNĐ thực tế
                ...
                loi_chi_tiet.append("VNDirect: Không tìm thấy dữ liệu mới nhất.")
        else:
...
with tab1:
    ...
    with st.spinner("Đang lấy dữ liệu thời gian thực..."):
        ...
        if not df.empty:
            # Hiển thị thêm ngày cập nhật để chắc chắn dữ liệu là của ngày hôm nay
            st.caption(f"Trạng thái kết nối: Dữ liệu được cấp bởi **{nguon}** (Ngày cập nhật hệ thống: {datetime.now().strftime('%d/%m/%Y')})")
