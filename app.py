...
# --- VŨ KHÍ MỚI: TỰ ĐỘNG CẬP NHẬT THỜI GIAN THỰC ĐỂ CHỐNG QUÁ TẢI API ---
@st.cache_data(ttl=900, show_spinner=False)
def lay_du_lieu(ma):
    loi_chi_tiet = []
    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'}
    
    # SỬ DỤNG THỜI GIAN THỰC TẾ: Lấy đúng 1 năm (365 ngày) gần nhất
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            if data.get('t') and len(data['t']) > 0:
                ...
                loi_chi_tiet.append("SSI: Từ chối cấp dữ liệu.")
...
with tab1:
    ...
    with st.spinner("Đang kết nối luồng dữ liệu bảo mật..."):
        ...
        # CHÚ Ý: Dòng lệnh phải được viết liền mạch thế này, không được xuống dòng hay thiếu dấu ngoặc
